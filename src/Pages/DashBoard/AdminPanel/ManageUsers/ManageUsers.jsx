                    ...
                    >
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className={`px-4 py-2 rounded-md text-white font-medium shadow-md transition-colors ${user.role === 'instructor' ? 'bg-blue-600' : 'bg-blue-500 hover:bg-blue-600'}`}
                            >
                                Make Instructor
                            </button>
                            <button
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-md text-white font-medium shadow-md transition-colors ${user.role === 'student' ? 'bg-purple-600' : 'bg-purple-500 hover:bg-purple-600'}`}
                            >
                                Make Student
                            </button>
                        </div>
